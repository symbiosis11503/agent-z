---
title: 名詞表 Glossary — 60+ 詞 5 個分類
description: AgentZ 名詞表 60+ 詞分 5 個分類頁面（基礎 / Agent 機制 / 實務 / Production / 台灣&pair），每詞 4 欄完整解釋（專業介紹 / 白話 / 範例 / 章節）。
---

# 名詞表 Glossary

AgentZ 用詞 + 業界術語的繁中對照。**60+ 詞分 5 個焦點頁面**，每詞 4 欄：專業介紹、白話解釋、應用範例、本書章節。
...
| 🛡 [**Production**](./glossary/production) | 治理 + Agentic-RL 訓練 | Budget Cap / Intervention / Audit / Replay / Guardrails / SFT / GRPO / Agentic-RL |
