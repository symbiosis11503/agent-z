---
title: 名詞表 Glossary — 70+ 詞 5 個分類
description: AgentZ 名詞表 70+ 詞分 5 個分類頁面（基礎 / Agent 機制 / 實務 / Production / 台灣&pair），每詞 4 欄完整解釋（專業介紹 / 白話 / 範例 / 章節）。涵蓋 ICE / Consensus Trap / Slopsquatting / ISO 42001 / NIST AI RMF / EU AI Act / OpenTelemetry GenAI 等 2026 合規與安全新詞。
---

# 名詞表 Glossary

AgentZ 用詞 + 業界術語的繁中對照。**70+ 詞分 5 個焦點頁面**，每詞 4 欄：專業介紹、白話解釋、應用範例、本書章節。
...
| 🤖 [**Agent 機制 + CLI / Claude Code + 多 agent 安全**](./glossary/agent) | Agent 機制本身 + Claude Code 生態系 + Multi-Agent Verification | Agent / Tool Use / ReAct / Plan-and-Solve / Reflection / Runaway / **stop_reason** / **Computer Use** / **Subagent** / **Deep Research** / **Headless Agent** / CLI Agent / MCP / Skill / Progressive Disclosure / Slash Command / Hook / **Plugin** / **Agent SDK** / **MCP Scope** / **ICE** / **Consensus Trap** / **Slopsquatting** |
...
| **ICE / Consensus Trap / Slopsquatting**（multi-agent 安全） | [Agent / CLI](./glossary/agent) |
